...
CREATE INDEX IF NOT EXISTS "UserRole_roleId_userId_idx"
  ON "UserRole" ("roleId","userId");
...
CREATE INDEX IF NOT EXISTS "RolePermission_permissionId_roleId_idx"
  ON "RolePermission" ("permissionId","roleId");
